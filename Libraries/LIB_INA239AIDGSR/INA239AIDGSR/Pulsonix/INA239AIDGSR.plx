...
//13736558/41184/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "INA239AIDGSR" (originalName "INA239AIDGSR")
	...
	(compDef "INA239AIDGSR" (originalName "INA239AIDGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "CS") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "MOSI") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "ALERT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "MISO") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SCLK") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "INA239AIDGSR"))
		...
		(attr "Mouser Part Number" "595-INA239AIDGSR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/INA239AIDGSR?qs=DRkmTr78QASO8y6Kfjsnog%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "INA239AIDGSR")
		(attr "Description" "Analog to Digital Converters - ADC 85-V, 16-bit, high-precision, SPI output current/voltage/power monitor with alert 10-VSSOP -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/ina239.pdf?ts=1614782670721")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "INA239AIDGSR.stp")
