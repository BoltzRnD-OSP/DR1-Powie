...
//16066412/41184/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LMR38020SDDAR" (originalName "LMR38020SDDAR")
	...
	(compDef "LMR38020SDDAR" (originalName "LMR38020SDDAR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "RT/SYNC") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "EP") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "SW") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "BOOT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "PG") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "FB") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LMR38020SDDAR"))
		...
		(attr "Mouser Part Number" "595-LMR38020SDDAR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LMR38020SDDAR?qs=Rp5uXu7WBW%252BVq2PF2vRuwg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LMR38020SDDAR")
		(attr "Description" "Switching Voltage Regulators SIMPLE SWITCHER power converter 4.2-V to 80-V, 2-A, synchronous buck with 40-uA IQ")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/lmr38020.pdf?ts=1639464026979&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FLMR38020")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "LMR38020SDDAR.stp")
